...
import { MainCoursItems } from '../../constants/MainCours'; 
      ...
      <div className="container mx-auto py-16 flex flex-col lg:flex-row gap-12">
        ...
        <div className="w-full lg:w-1/2 lg:pl-8">
          ...
          <div className="space-y-8">
            {MainCoursItems.map((item, index) => (  // Ensure this matches the correct export name
        ...
        <div className="w-full lg:w-[448px] mb-8 lg:mb-0">
          <Image
            src="/images/mainCourse.png" // Correct image path
